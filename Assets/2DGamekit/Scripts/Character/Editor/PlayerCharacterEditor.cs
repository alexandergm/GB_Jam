...
namespace Gamekit2D
{
    ...
    public class PlayerCharacterEditor : Editor
    {
        ...
        SerializedProperty m_HelicopterProp;
        SerializedProperty m_SuperPowerProp;
        ...
        readonly GUIContent m_HelicopterContent = new GUIContent("Helicopter");
        readonly GUIContent m_SuperPowerContent = new GUIContent("Super Power");
        ...
        void OnEnable ()
        {
            ...
            m_SuperPowerProp = serializedObject.FindProperty("powerObj");
            m_HelicopterProp = serializedObject.FindProperty("helicopter");
        ...
        public override void OnInspectorGUI ()
        {
            ...
            if (m_ReferencesFoldout)
            {
                ...
                EditorGUILayout.PropertyField (m_HelicopterProp, m_HelicopterContent);
                EditorGUILayout.PropertyField (m_SuperPowerProp, m_SuperPowerContent);
